...
public class AdvancedSearchPage extends BasePage {
    ...
    public AdvancedSearchPage(WebDriver driver) {
        ...
        this.advBtn      = new Button(driver, wait, BTN_ADV);
        this.firstInput  = new Input(wait, INPUT1);
        this.secondInput = new Input(wait, INPUT2);
        this.searchBtn   = new Button(driver, wait, BTN_SEARCH);
        this.clearBtn    = new Button(driver, wait, BTN_CLEAR);
    }
